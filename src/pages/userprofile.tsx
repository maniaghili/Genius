                 ...
                 <div className="w-full h-full gap-5 flex items-center flex-col">
                    ...
                    <div className="h-fit mb-4 w-full flex justify-center">
                      <ul className="bg-slate-200 dark:text-gray-300 dark:bg-slate-900 w-full flex flex-col  items-center rounded-xl h-full">
                          ...
                          <li className="hover:bg-blue-500 cursor-pointer transition-all bg-slate-100 dark:bg-gray-800 flex justify-start  gap-1 items-center w-[90%] h-9 rounded-2xl mt-4">
                             <Link to={'/userprofile/courses'} className="h-full flex justify-start w-full gap-1 items-center">
                          ...
                          <li className="hover:bg-blue-500 cursor-pointer transition-all bg-slate-100 dark:bg-gray-800 flex justify-start  gap-1 items-center w-[90%] h-9 rounded-2xl mt-4">
                          <Link to={'/userprofile/userInfos'} className="h-full flex justify-start w-full gap-1 items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
                          ...
                          <li className="hover:bg-blue-500 cursor-pointer transition-all bg-slate-100 dark:bg-gray-800 flex justify-start  gap-1 items-center w-[90%] h-9 rounded-2xl mt-4">
                          <Link to={'/userprofile/userTickets'} className="h-full flex justify-start w-full gap-1 items-center">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
                          ...
                          }} className="hover:bg-red-700 cursor-pointer transition-all mb-4 dark:bg-gray-800 bg-slate-100 flex justify-start  gap-1 items-center w-[90%] h-9 rounded-2xl mt-4">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
