     ...
     <p className="font-bold my-2 text-[14px]">دیدگاه ها</p>
            <div className="border dark:border-gray-700 rounded-2xl flex flex-col gap-5">
              ...
              <div className="w-full flex justify-center">
                ...
                }} onBlur={(e)=>{setCommentBody(e.target.value as SetStateAction<any>)}} className="bg-slate-200 dark:border-gray-700 dark:bg-gray-700 w-11/12 h-36 rounded-2xl"  placeholder="نظر خود را وارد کنید">
