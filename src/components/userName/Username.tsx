  ...
  const user = useContext(userInfo)
   ...
   return (  
     <div className="flex items-center dark:text-gray-300 h-full group relative ">
         ...
         <ul className="group-hover:visible dark:bg-gray-900 drop_down bg-slate-50 absolute top-16 w-44 left-4  overflow-hidden min-h-40 rounded-lg">
          <li className="text-black dark:text-gray-300 mt-1 cursor-pointer gap-3  h-8 flex items-center hover:text-blue-500">
          <Link className="flex gap-3 items-center w-full h-full" to={navigateUser('/userprofile/userInfos','/login')}>
          ...
          <li className="text-black dark:text-gray-300 mt-1 gap-3 cursor-pointer h-8 flex items-center hover:text-blue-500">
          <Link className="flex gap-3 items-center w-full h-full" to={'/series'} >
           <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className=" w-5 h-5">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 0 0-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 0 0-16.536-1.84M7.5 14.25 5.106 5.272M6 20.25a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Zm12.75 0a.75.75 0 1 1-1.5 0 .75.75 0 0 1 1.5 0Z"></path></svg>
           <p className="text-[13px] font-bold"> سبد خرید</p>
          ...
          
             {
               name && isName &&
               <>
               <li className="text-black dark:bg-gray-900 dark:text-white mt-1  gap-3 cursor-pointer h-8 flex items-center  hover:text-blue-500">
